...
- [blocked] Stitch payment: corrected OAuth token and payment-link endpoints; Stitch still rejects the supplied pair as `invalid_client`, so a matching API Client ID + Client Secret is required
